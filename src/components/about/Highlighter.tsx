...
export function H1({ children }: HighlighterProps){
  return (
    <div className={`text-4xl sm:text-5xl md:text-7xl mb-16`}>
      <Code>{`<h1>`}</Code>
      <code className={`inline text-white ${amarante.className}`}>
        {children}
      </code>
      <Code>{`</h1>`}</Code>
    </div>
...
export function H2({ children }: HighlighterProps){
  return (
...
export function P({ children }: HighlighterProps){
  return (
    <div className="text-lg mb-5">
      <Code>{`<p>`}</Code>
      <code className={`inline text-white ${bodoni.className}`}>
        {children}
      </code>
      <Code>{`</p>`}</Code>
    </div>
...
function Code({ children }: HighlighterProps) {
  return (
    <code className={`inline text-gray-800 ${amarante.className}`}>
      {children}
    </code>
  );
}
