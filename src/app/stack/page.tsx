...
export default function Stack() {
  ...
  useEffect(() => {
    ...
    const objects: {mesh:THREE.Mesh<THREE.BoxGeometry, THREE.MeshStandardMaterial, THREE.Object3DEventMap>, body:CANNON.Body}[] = [];
    ...
    type Position = {x:number, y:number, z:number} | CANNON.Vec3
    function createBox(width: number, height: number, depth: number, position: CANNON.Vec3, texture: string) {
      //three mesh
    ...
    textures.forEach((texture, i) => {
      const position = positions[0][i]
      createBox(1, 1, 1, new CANNON.Vec3(position.x, position.y, position.z), texture);
    });
    ...
    function createSphere(radius: number, position: Position) {
